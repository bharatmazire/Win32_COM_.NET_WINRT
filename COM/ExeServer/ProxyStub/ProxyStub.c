...
extern const MIDL_SERVER_INFO IMinus_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IMinus_ProxyInfo;
...
/* 22 */	NdrFcShort( 0x0 ),	/* 0 */
	...
	/* Parameter __MIDL__IMinus0000 */


	/* Parameter __MIDL__IAdd0000 */
...
/* 28 */	0x8,		/* FC_LONG */
	...
	/* Parameter __MIDL__IMinus0001 */


	/* Parameter __MIDL__IAdd0001 */
...
/* 34 */	0x8,		/* FC_LONG */
	...
	/* Parameter __MIDL__IMinus0002 */


	/* Parameter __MIDL__IAdd0002 */
...
/* Object interface: IAdd, ver. 0.0,
   GUID={0x09749A69,0xD03E,0x4165,{0xBF,0x6D,0x5A,0x09,0xEB,0x3F,0xD0,0x46}} */
...
CINTERFACE_PROXY_VTABLE(4) _IAddProxyVtbl = 
{
    ...
    (void *) (INT_PTR) -1 /* IAdd::SumOfTwoIntegers */
};
...
/* Object interface: IMinus, ver. 0.0,
   GUID={0xAFD72FA6,0x4C74,0x4AF1,{0x97,0xC0,0x7A,0x85,0x95,0x01,0x15,0x97}} */

#pragma code_seg(".orpc")
static const unsigned short IMinus_FormatStringOffsetTable[] =
    {
    0
    };

static const MIDL_STUBLESS_PROXY_INFO IMinus_ProxyInfo =
    {
    &Object_StubDesc,
    ProxyStub__MIDL_ProcFormatString.Format,
    &IMinus_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IMinus_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    ProxyStub__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(4) _IMinusProxyVtbl = 
{
    &IMinus_ProxyInfo,
    &IID_IMinus,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    (void *) (INT_PTR) -1 /* IMinus::SubtractionOfTwoIntegers */
};

const CInterfaceStubVtbl _IMinusStubVtbl =
{
    &IID_IMinus,
    &IMinus_ServerInfo,
    4,
...
const CInterfaceProxyVtbl * const _ProxyStub_ProxyVtblList[] = 
{
    ...
    ( CInterfaceProxyVtbl *) &_IMinusProxyVtbl,
    0
};
...
const CInterfaceStubVtbl * const _ProxyStub_StubVtblList[] = 
{
    ...
    ( CInterfaceStubVtbl *) &_IMinusStubVtbl,
    0
};
