...
interface INoAggrigationIUnknown
{
...
class CMultiplicationDivision : public INoAggrigationIUnknown, IMultiplication, IDivision
{
private:
	long m_cRef;
...
CMultiplicationDivision::CMultiplicationDivision(IUnknown * pIUnknownOuter)
{
	...
	if (pIUnknownOuter != NULL)
		...
		m_pIUnknownOuter = reinterpret_cast<IUnknown *>(static_cast<INoAggrigationIUnknown *>(this));
}
...
HRESULT CMultiplicationDivision::QueryInterface_NoAggregation(REFIID riid, void ** ppv)
{
	if (riid == IID_IUnknown)
		*ppv = static_cast<INoAggrigationIUnknown *>(this);			// method coloring
