...
extern "C" void Football(LPSTATE State)

{

	State->Points[0] = POINTEX({ 0,0,-2 });

	State->Points[1] = POINTEX({ 0,0,2 });

	State->Points[2] = POINTEX({ 2,0,4 });

	State->Points[3] = POINTEX({ 5,0,6 });

	State->Points[4] = POINTEX({ 7,0,6 });

	State->Points[5] = POINTEX({ 10,0,4 });

	State->Points[6] = POINTEX({ 12,0,2 });

	State->Points[7] = POINTEX({ 12,0,-2 });

	State->Points[8] = POINTEX({ 10,0,-4 });

	State->Points[9] = POINTEX({ 7,0,-6 });

	State->Points[10] = POINTEX({ 5,0,-6 });

	State->Points[11] = POINTEX({ 2,0,-4 });

	State->Points[12] = POINTEX({ 2,3,0 });

	State->Points[13] = POINTEX({ 4,2,4 });

	State->Points[14] = POINTEX({ 8,2,4 });

	State->Points[15] = POINTEX({ 10,3,0 });

	State->Points[16] = POINTEX({ 8,2,-4 });

	State->Points[17] = POINTEX({ 4,2,-4 });

	State->Points[18] = POINTEX({ 4,4,0 });

	State->Points[19] = POINTEX({ 5,4,2 });

	State->Points[20] = POINTEX({ 7,4,2 });

	State->Points[21] = POINTEX({ 8,4,0 });

	State->Points[22] = POINTEX({ 6,4,-2 });
	...
	State->Model.arrLine[1].ptEnd = &State->Points[12];



	State->Model.arrLine[2].ptStart = &State->Points[1];

	State->Model.arrLine[2].ptEnd = &State->Points[2];



	State->Model.arrLine[3].ptStart = &State->Points[1];

	State->Model.arrLine[3].ptEnd = &State->Points[12];
	...
	State->Model.arrLine[5].ptEnd = &State->Points[18];



	State->Model.arrLine[6].ptStart = &State->Points[3];

	State->Model.arrLine[6].ptEnd = &State->Points[13];



	State->Model.arrLine[7].ptStart = &State->Points[3];

	State->Model.arrLine[7].ptEnd = &State->Points[4];



	State->Model.arrLine[8].ptStart = &State->Points[4];

	State->Model.arrLine[8].ptEnd = &State->Points[14];



	State->Model.arrLine[9].ptStart = &State->Points[4];

	State->Model.arrLine[9].ptEnd = &State->Points[5];



	State->Model.arrLine[10].ptStart = &State->Points[5];

	State->Model.arrLine[10].ptEnd = &State->Points[14];



	State->Model.arrLine[11].ptStart = &State->Points[5];

	State->Model.arrLine[11].ptEnd = &State->Points[6];



	State->Model.arrLine[12].ptStart = &State->Points[6];

	State->Model.arrLine[12].ptEnd = &State->Points[15];



	State->Model.arrLine[13].ptStart = &State->Points[6];

	State->Model.arrLine[13].ptEnd = &State->Points[7];



	State->Model.arrLine[14].ptStart = &State->Points[7];

	State->Model.arrLine[14].ptEnd = &State->Points[15];



	State->Model.arrLine[15].ptStart = &State->Points[7];

	State->Model.arrLine[15].ptEnd = &State->Points[8];



	State->Model.arrLine[16].ptStart = &State->Points[8];

	State->Model.arrLine[16].ptEnd = &State->Points[16];



	State->Model.arrLine[17].ptStart = &State->Points[8];

	State->Model.arrLine[17].ptEnd = &State->Points[9];



	State->Model.arrLine[18].ptStart = &State->Points[9];

	State->Model.arrLine[18].ptEnd = &State->Points[16];



	State->Model.arrLine[19].ptStart = &State->Points[9];

	State->Model.arrLine[19].ptEnd = &State->Points[10];



	State->Model.arrLine[20].ptStart = &State->Points[10];

	State->Model.arrLine[20].ptEnd = &State->Points[17];



	State->Model.arrLine[21].ptStart = &State->Points[10];

	State->Model.arrLine[21].ptEnd = &State->Points[11];



	State->Model.arrLine[22].ptStart = &State->Points[11];

	State->Model.arrLine[22].ptEnd = &State->Points[17];



	State->Model.arrLine[23].ptStart = &State->Points[11];

	State->Model.arrLine[23].ptEnd = &State->Points[0];



	State->Model.arrLine[24].ptStart = &State->Points[12];

	State->Model.arrLine[24].ptEnd = &State->Points[18];



	State->Model.arrLine[25].ptStart = &State->Points[13];

	State->Model.arrLine[25].ptEnd = &State->Points[19];



	State->Model.arrLine[26].ptStart = &State->Points[14];

	State->Model.arrLine[26].ptEnd = &State->Points[20];



	State->Model.arrLine[27].ptStart = &State->Points[15];

	State->Model.arrLine[27].ptEnd = &State->Points[21];



	State->Model.arrLine[28].ptStart = &State->Points[16];

	State->Model.arrLine[28].ptEnd = &State->Points[22];



	State->Model.arrLine[29].ptStart = &State->Points[17];

	State->Model.arrLine[29].ptEnd = &State->Points[22];



	State->Model.arrLine[30].ptStart = &State->Points[18];

	State->Model.arrLine[30].ptEnd = &State->Points[19];



	State->Model.arrLine[31].ptStart = &State->Points[19];

	State->Model.arrLine[31].ptEnd = &State->Points[20];



	State->Model.arrLine[32].ptStart = &State->Points[20];

	State->Model.arrLine[32].ptEnd = &State->Points[21];



	State->Model.arrLine[33].ptStart = &State->Points[21];

	State->Model.arrLine[33].ptEnd = &State->Points[22];



	State->Model.arrLine[34].ptStart = &State->Points[22];

	State->Model.arrLine[34].ptEnd = &State->Points[18];



	State->Model.arrLine[35].ptStart = &State->Points[0];

	State->Model.arrLine[35].ptEnd = &State->Points[11];



	State->Model.iNoOfPoints = 23;
